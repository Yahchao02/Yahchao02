...
Ход работы:
- Для начала нужно было выбрать конкретную игру. Genshin Impact - многопользовательская компьютерная онлайн игра, в которую можно играть как одному, так и в корпаративе.
- Концепт игры: Приключенческая игра с открытым миром. В которой есть возможность залезть и исследовать любую часть виртуального мира. Погрузиться в интересный сюжет и пытаться разгадать загадки в этом мире. Так же можно прокачивать персонажей, но для этого нужно искать ресурсы.:
- Взаимодействие стихий и разнообразные боевые тактики; - Отправляйтесь в путешествие с компаньонами.
- Скриншот геймплея игры:
![image](http://static.pasifik.ru/uploads/gallery/K82234ce76/769d34a1ce.jpg)
...
![image](https://github.com/Yahchao02/Yahchao02/blob/main/274599027-785ff3fb-f7e7-4b1b-ba86-d9c9b8d6f0c1%20(1).png)
...
## Выводы
- В ходе данной лабораторной работы я познакомилась с визуализацией даных из таблицы GoogleSheets в Unity, с их визуализацие и работой со звуковыми эффектами в Unity с помощью скриптов на языках Python и C#. Смогла вывести и изменить условия воспроизведения звуков и прослушала эти звуки, в зависимости от данных из Google-таблицы, которые были получены с помощью скрипта на языке Python.
